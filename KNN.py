# -*- coding: utf-8 -*-
"""
Created on Tue Jun  6 10:58:20 2023
...
#划分训练测试集
    ...
    best_knn = KNeighborsClassifier(n_neighbors=19)	# 选择最优的K=15传入模型
...
#训练        
    ...
    scores = cross_val_score(best_knn,y_true, y_pred,cv=10,scoring='accuracy')
